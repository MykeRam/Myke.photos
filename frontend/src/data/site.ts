...
export const portfolioCategories: PortfolioCategory[] = [
  ...
  { slug: 'analog', title: 'Analog', description: 'Photographs shaped by grain, patience, and chance.' }
];
...
export const featuredPhotos: Photo[] = [
  ...
  { slug: 'after-the-rain', title: 'After the rain', category: 'Analog', location: 'Queens, NY', image: '/images/study-02.svg', alt: 'Abstract reflections and soft light after rainfall', orientation: 'portrait' }
];
